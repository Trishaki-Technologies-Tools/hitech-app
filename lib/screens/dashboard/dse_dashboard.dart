...
import '../dse/followup_screen.dart';
...
class DSEDashboard extends StatefulWidget {
  ...
  @override
  State<DSEDashboard> createState() => _DSEDashboardState();
}

class _DSEDashboardState extends State<DSEDashboard> {
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(2, Icons.assignment_turned_in_outlined, Icons.assignment_turned_in_rounded),
              _buildNavItem(3, Icons.calendar_month_outlined, Icons.calendar_month_rounded),
